...
const QUIZ_QUESTIONS = [
  {
    ...
    correct: 'שניות — בדיוק כמה שלוקח למצוא נעליים 90',
  ...
  },
  {
    ...
    correct: 'הדוד ג׳ורג׳ עושה 47% יותר טוב וכולם יודעים',
  ...
  },
  {
    ...
    correct: 'שורף הכל לפחם ומכריז ש״יצא מושלם״',
  ...
  },
  {
    ...
    correct: 'במגירה שנייה מלמטה, מתחת למכתב ממס הכנסה',
  ...
  },
  {
    ...
    correct: 'בודק אם זה ווטסאפ, פוש מפיקוד העורפי, או וואלה',
    wrong: 'עונה בדאגה',
  },
  {
    question: '?מה ישראלי עושה כשהוא שומע ״ירי לעבר רכב״ בחדשות',
    correct: 'כבר שלח 4 הודעות ״הכל בסדר?״ לכל הקבוצות',
