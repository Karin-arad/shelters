...
const QUIZ_QUESTIONS = [
  {
    ...
    correct: '90 שניות — כמה שלוקח למצוא נעליים',
    wrong: 'דקות — מספיק לסיים את הקפה 3',
  },
  {
    question: '?מה עושה ישראלי כשהאזעקה נשמעת בלילה',
    correct: 'יורד עם שמיכה בלי משקפיים',
    wrong: 'קם בסדר, לובש נעליים ויוצא בשלווה',
  },
  {
    question: '?מה מכיל המקלט הסטנדרטי בישראל',
    correct: 'אופניים שבורים וצעצועים מ-2009',
    wrong: 'ציוד חירום, מים ואוכל לשלושה ימים',
  },
  {
    question: '?מה ההבדל בין חומוס ישראלי לחומוס של הדוד ג׳ורג׳',
    correct: 'הדוד ג׳ורג׳ עושה 47% יותר טוב',
    wrong: 'אין הבדל, חומוס זה חומוס',
  },
  {
    question: '?מה הצעד הראשון לפני נסיעה לחו״ל',
    correct: 'בודק איפה בית חב״ד הכי קרוב למלון',
    wrong: 'בודק ויזה ומזמין מלון',
  },
  {
    question: '?מה ישראלי שולף מהמקפיא בשעת חירום',
    correct: 'פיתות קפואות מ-2022 ושאריות שקשוקה',
    wrong: 'קופסת עזרה ראשונה',
  },
  {
    question: '?מה תגובת ישראלי לשאלה ״מה שלומך?״',
    correct: '״בסדר יחסית״ ואז 12 דקות על המצב',
    wrong: '״טוב, תודה, ואתה?״',
  },
  {
    question: '?מה עושה ישראלי כשמסתיימת האזעקה',
    correct: 'מסתכל בשמים ומסביר ״זה היה יירוט״',
    wrong: 'חוזר בשקט למיטה',
  },
  {
    question: '?איך ישראלי עושה על האש',
    correct: 'שורף הכל ומכריז ש״יצא מושלם״',
    wrong: 'מדליק אש, ממתין שתדעך, שם רשת',
  },
  {
    question: '?מה נגמר בסופר לפני אזעקה',
    correct: 'לחם, מים וביצים — תוך 11 דקות',
  ...
  },
  {
    ...
    correct: 'במגירה מתחת למכתב ממס הכנסה',
    wrong: 'בכיס נייד מסודר עם מסמכי חירום',
  },
  {
    question: '?מה עושה ישראלי ב״שקט״ בין שתי מלחמות',
    correct: 'צופה בחדשות כל 20 דקות ומחכה',
    wrong: 'נושם, מתאושש, עושה תוכניות',
  },
  {
    question: '?מה ישראלי אומר בסוף ארוחה מלאה',
    correct: '״יאללה, עוד פיתה לניקוי הצלחת״',
    wrong: '״תודה, אכלתי מספיק״',
  },
  {
    question: '?מה עושה ישראלי כשמצלצל הטלפון בשעתיים בלילה',
    correct: 'בודק אם זה ווטסאפ או פיקוד העורף',
    wrong: 'עונה בדאגה',
  },
  {
    question: '?מה ישראלי עושה כשהוא שומע ״ירי לעבר רכב״ בחדשות',
    correct: 'כבר שלח ״הכל בסדר?״ לכל הקבוצות',
    wrong: 'ממתין לפרטים נוספים לפני שמגיב',
  },
];
